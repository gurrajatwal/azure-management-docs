...
|--------|---------------|---------|
|`Extension failed to install. Install of extension failed with error: HandlerManifest.json file does not exist`|The extension was not uninstalled properly|Manually cleanup the extension on the machine and reinstall|
